...
const ShowUsage = () => {
    ...
    useEffect(() => {
        fetch(`${config['baseUrl']}/getUsageAndLimitation`, {
            method: 'GET',
    ...
    const Update = () => {
        if (data == '') {
            alert("Enter Usage Policy!")
        }
        else {
            const submit = { description: data }
            fetch(`${config['baseUrl']}/usageAndLimitationInsertAndUpdate`, {
                method: "POST",
                ...
                console.log(`Updated Usage Policy`)
            })
        }
