...
const ShowTermination = () => {
    ...
    useEffect(() => {
        fetch(`${config['baseUrl']}/getTermination`, {
            method: 'GET',
    ...
    const Update = () => {
        if (data == '') {
            alert("Enter Termination!")
        }
        else {
            const submit = { description: data }
            fetch(`${config['baseUrl']}/terminationInsertAndUpdate`, {
                method: "POST",
...
export default ShowTermination