...
const ShowMaintenance = () => {
    ...
    useEffect(() => {
        fetch(`${config['baseUrl']}/getMaintainance`, {
            method: 'GET',
    ...
    const Update = () => {
        if (data == '') {
            alert("Enter Maintenance and Warranties!")
        }
        else {
            const submit = { description: data }
            fetch(`${config['baseUrl']}/maintainanceInsertAndUpdate`, {
                method: "POST",
                ...
                console.log(`Updated Maintenance and Warranties`)
            })
        }
                ...
                <div className="col-md-12 aera py-4 px-5 mt-5">
                    <div className="row">
                        <div className="col-md-12 mb-2">
                            <h1>Maintenance and Warranties</h1>
                        </div>
                    </div>
                    {
                        check ?
