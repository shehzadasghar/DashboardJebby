...
const ShowInsurance = () => {
    ...
    useEffect(() => {
        fetch(`${config['baseUrl']}/getInsurance`, {
            method: 'GET',
    ...
    const Update = () => {
        if (data == '') {
            alert("Enter Insurance and Indemnification!")
        }
        else {
            const submit = { description: data }
            fetch(`${config['baseUrl']}/insuranceInsertAndUpdate`, {
                method: "POST",
                ...
                console.log(`Updated Insurance and Indemnification`)
            })
        }
                ...
                <div className="col-md-12 aera py-4 px-5 mt-5">
                    <div className="row">
                        <div className="col-md-12 mb-2">
                            <h1>Current Insurance and Indemnification</h1>
                        </div>
                    </div>
                    {
                        check ?
